...
### ✨ Key Features
  ...
  * **Real-time Data Fetching:** Automated script to pull current market prices, market cap, and 24h volume.
  * **Relational Mapping:** Robust database schema to ensure data integrity.
  * **RESTful API:** Clean endpoints to query stored data by coin symbol.
  * **Automatic Documentation:** Interactive Swagger/OpenAPI UI included.
